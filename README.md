...
package tutorial. For brevity, we am not reproducing the code here, but
...
comparing the name to names in a database; we used the U.S. Social
...
the number of male and female authors of each preprint, regardless of
...
df.all2020$COVID <- ifelse(as.Date(df.all2020$submitted) < start.date, "January 1-February 29, 2020", ifelse(as.Date(df.all2020$submitted) < "2020-05-01", "March 1-April 30, 2020", "May 1-June 30, 2020")) #Classify dates as COVID or not
...
colnames(arxiv.t) <- c("January 1-February 29, 2020", "March 1-April 30, 2020", "May 1-June 30, 2020") #Fix column names
arxiv.t$per1 <- ((arxiv.t$`May 1-June 30, 2020`-arxiv.t$`January 1-February 29, 2020`)/(arxiv.t$`January 1-February 29, 2020`))*100 #Calculate percent change
arxiv.long$per <- c(arxiv.t$per1[1], arxiv.t$per1[1], arxiv.t$per1[1], arxiv.t$per1[2], arxiv.t$per1[2],arxiv.t$per1[2]) #Add percent change to long-format dataframe
bump = 3000 #Set for figure annotatin
arxiv.long$y <- c(18500, 18500, 18500, 61500, 61500, 61500)
arxiv.long$x <- c(1.3,1.3,1.3,2.3,2.3,2.3) #X coordinates for figure text annotation
...
colnames(arxiv.sole.t) <- c("January 1-February 29, 2020", "March 1-April 30, 2020", "May 1-June 30, 2020") #Fix column names
arxiv.sole.t$per <- ((arxiv.sole.t$`May 1-June 30, 2020`-arxiv.sole.t$`January 1-February 29, 2020`)/(arxiv.sole.t$`January 1-February 29, 2020`))*100 #Calculate percent change
arxiv.sole.long$per <- c(arxiv.sole.t$per[1],arxiv.sole.t$per[1],arxiv.sole.t$per[1],arxiv.sole.t$per[2],arxiv.sole.t$per[2],arxiv.sole.t$per[2]) #Add percent change to long-format dataframe
bump = 150 #Set for figure annotation
arxiv.sole.long$y <- c((arxiv.sole.long[3,3]+bump), (arxiv.sole.long[3,3]+bump), (arxiv.sole.long[3,3]+bump), (arxiv.sole.long[6,3]+bump), (arxiv.sole.long[6,3]+bump), (arxiv.sole.long[6,3]+bump)) #Y coordinates for figure text annotation
arxiv.sole.long$x <- c(1.3,1.3,1.3,2.3,2.3,2.3) #X coordinates for figure text annotation
