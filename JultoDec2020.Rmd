...
This repo updates the data and code for the analyses in:
...
We scraped the data in batches, as recommended in the aRxiv package tutorial. For brevity, we are not reproducing the code here, but it is available in the [R markdown file](https://github.com/drfreder/king-and-frederickson/master/README.Rmd) included in this repo.

We previously scraped data through June 30, 2020. Here, we add data from July 1, 2020 through December 28, 2020. 

```{r Scrape arXiv, include=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
#Not run
#July to December data
n.update <- arxiv_count(query = 'submittedDate:[202007010000 TO 202012282400]')
n.update.1 <- arxiv_count(query = 'submittedDate:[202007010000 TO 202007152400]')
df.update.1 <- arxiv_search(query = 'submittedDate:[202007010000 TO 202007152400]', limit=n.update.1, batchsize=2000)
n.update.2 <- arxiv_count(query = 'submittedDate:[202007160000 TO 202007312400]')
df.update.2 <- arxiv_search(query = 'submittedDate:[202007160000 TO 202007312400]', limit=n.update.2, batchsize=2000)
n.update.3 <- arxiv_count(query = 'submittedDate:[202008010000 TO 202008152400]')
df.update.3 <- arxiv_search(query = 'submittedDate:[202008010000 TO 202008152400]', limit=n.update.3, batchsize=2000)
n.update.4 <- arxiv_count(query = 'submittedDate:[202008160000 TO 202008312400]')
df.update.4 <- arxiv_search(query = 'submittedDate:[202008160000 TO 202008312400]', limit=n.update.4, batchsize=2000)
n.update.5 <- arxiv_count(query = 'submittedDate:[202009010000 TO 202009152400]')
df.update.5 <- arxiv_search(query = 'submittedDate:[202009010000 TO 202009152400]', limit=n.update.5, batchsize=2000)
n.update.6 <- arxiv_count(query = 'submittedDate:[202009160000 TO 202009302400]')
df.update.6 <- arxiv_search(query = 'submittedDate:[202009160000 TO 202009302400]', limit=n.update.6, batchsize=2000)
n.update.7 <- arxiv_count(query = 'submittedDate:[202010010000 TO 202010152400]')
df.update.7 <- arxiv_search(query = 'submittedDate:[202010010000 TO 202010152400]', limit=n.update.7, batchsize=2000)
n.update.8 <- arxiv_count(query = 'submittedDate:[202010160000 TO 202010312400]')
df.update.8 <- arxiv_search(query = 'submittedDate:[202010160000 TO 202010312400]', limit=n.update.8, batchsize=2000)
n.update.9 <- arxiv_count(query = 'submittedDate:[202011010000 TO 202011102400]')
df.update.9 <- arxiv_search(query = 'submittedDate:[202011010000 TO 202011102400]', limit=n.update.9, batchsize=2000)
n.update.10 <- arxiv_count(query = 'submittedDate:[202011120000 TO 202011302400]')
df.update.10 <- arxiv_search(query = 'submittedDate:[202011120000 TO 202011302400]', limit=n.update.10, batchsize=2000)
#Records for Nov 11 giving me error messages
#n.update.11 <- arxiv_count(query = 'submittedDate:[202011110600 TO 202011111200]')
#df.update.11 <- arxiv_search(query = 'submittedDate:[202011110600 TO 202011111200]', limit=n.update.11, batchsize=500)
n.update.12 <- arxiv_count(query = 'submittedDate:[202012010000 TO 202012282400]')
df.update.12 <- arxiv_search(query = 'submittedDate:[202012010000 TO 202012282400]', limit=n.update.12, batchsize=2000)

df.update <- rbind(df.update.1, df.update.2, df.update.3, df.update.4, df.update.5, df.update.6, df.update.7, df.update.8, df.update.9, df.update.10, df.update.12)
n.update - length(df.update$id)

#n.update - length(df.update$id)
write.csv(df.update, file="Data/arxiv_JulDec2020_data.csv")
```
...
df.2020.part2 <- read.csv("Data/arxiv_JulDec2020_data.csv")
df.all2020 <- rbind(df.2020, df.early2020, df.update, df.update.2, df.mayjune2020, df.2020.part2) #Full 2020 data
...
write.csv(df.full.output, "Data/arxiv_full_gender_all2020.csv") #Save data
...
write.csv(df.all2020.output, "Data/arxiv_all2020fullyear_gender.csv") #Save data
```
...
df.full <- read.csv("Data/arxiv_full_gender_all2020.csv") #Read in data
...
df.all2020 <- read.csv("Data/arxiv_all2020fullyear_gender.csv") #Read in data
...
arxiv <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27") %>% group_by(round_date(as.Date(submitted), unit="weeks", week_start = getOption("lubridate.week.start", 1))) %>% summarize(female.n=sum(female.n, na.rm=TRUE), male.n=sum(male.n, na.rm=TRUE))))
...
arxiv.long$COVID <- ifelse(arxiv.long$`as.Date(submitted)` < who, "N", "Y")

#Fit mdoel
lm1 <- lm(sqrt(n)~date*gender*COVID+day_of_week, data=arxiv.long)
summary(lm1)
Anova(lm1, type=3)
#plot(lm1)
```
...
arxiv.sole <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27" & author.n==1) %>% group_by(round_date(as.Date(submitted), unit="weeks", week_start = getOption("lubridate.week.start", 1))) %>% summarize(female.n=sum(female.n, na.rm=TRUE), male.n=sum(male.n, na.rm=TRUE))))
...
p7 <- ggplot(data=subset(arxiv.sole.long, as.Date(week) >= "2020-01-01" & as.Date(week) <= "2020-12-27"), aes(x=as.Date(week), y=n, color=gender, shape=gender))+geom_point(size=2)+geom_smooth(method="lm", se=FALSE)+ylab("Authorships (no.)")+xlab("Date")+theme_cowplot()+scale_color_manual(name="Gender", labels=c("Men", "Women"), values=colours2)+labs(title="arXiv", subtitle="sole authorships")+scale_shape_discrete(name="Gender", labels=c("Men", "Women"))+geom_vline(aes(xintercept=as.Date(who)), linetype="dashed")+scale_x_date(date_labels = "%b %Y")+theme(axis.text.x=element_text(angle=60, hjust=1), legend.position="top")
p7

#Model
arxiv.sole <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27" & author.n == 1) %>% group_by(as.Date(submitted)) %>% summarize(female.n=sum(female.n, na.rm=TRUE), male.n=sum(male.n, na.rm=TRUE)))) #Summarize by month
arxiv.sole.long <- gather(arxiv.sole, gender, n, female.n:male.n)
...
arxiv.first <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27" & !is.na(first.author.gender)) %>% group_by(round_date(as.Date(submitted), unit="weeks", week_start = getOption("lubridate.week.start", 1)), first.author.gender) %>% summarize(n=n())))
colnames(arxiv.first) <- c("week", "gender", "n")
arxiv.first$gender <- factor(arxiv.first$gender, rev(levels(as.factor(arxiv.first$gender))))

p8 <- ggplot(data=subset(arxiv.first, as.Date(week) >= "2020-01-01" & as.Date(week) <= "2020-12-27"), aes(x=as.Date(week), y=n, color=gender, shape=gender))+geom_point(size=2)+geom_smooth(method="lm", se=FALSE)+ylab("Authorships (no.)")+xlab("Date")+theme_cowplot()+scale_color_manual(name="Gender", labels=c("Men", "Women"), values=colours2)+scale_shape_discrete(name="Gender", labels=c("Men", "Women"))+geom_vline(aes(xintercept=as.Date("2020-03-11")), linetype="dashed")+labs(title="arXiv", subtitle="first authorships")+scale_x_date(date_labels = "%b %Y")+theme(axis.text.x=element_text(angle=60, hjust=1), legend.position="top")
p8

#Model
arxiv.first <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27" & !is.na(first.author.gender)) %>% group_by(as.Date(submitted), first.author.gender) %>% summarize(n=n())))
...
arxiv.last <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27" & !is.na(last.author.gender)) %>% group_by(round_date(as.Date(submitted), unit="weeks", week_start = getOption("lubridate.week.start", 1)), last.author.gender) %>% summarize(n=n())))
colnames(arxiv.last) <- c("week", "gender", "n")
arxiv.last$gender <- factor(arxiv.last$gender, rev(levels(as.factor(arxiv.last$gender))))

p9 <- ggplot(data=subset(arxiv.last, as.Date(week) >= "2020-01-01" & as.Date(week) <= "2020-12-27"), aes(x=as.Date(week), y=n, color=gender, shape=gender))+geom_point(size=2)+geom_smooth(method="lm", se=FALSE)+ylab("Authorships (no.)")+xlab("Date")+theme_cowplot()+scale_color_manual(name="Gender", labels=c("Men", "Women"), values=colours2)+scale_shape_discrete(name="Gender", labels=c("Men", "Women"))+geom_vline(aes(xintercept=as.Date("2020-03-11")), linetype="dashed")+labs(title="arXiv", subtitle="last authorships")+scale_x_date(date_labels = "%b %Y")+theme(axis.text.x=element_text(angle=60, hjust=1), legend.position="top")
p9

#Model
arxiv.last <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27" & !is.na(last.author.gender)) %>% group_by(as.Date(submitted), last.author.gender) %>% summarize(n=n())))
...
arxiv.middle <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27") %>% group_by(round_date(as.Date(submitted), unit="weeks", week_start = getOption("lubridate.week.start", 1))) %>% summarize(female.n=sum(female.mid.authors.n, na.rm=TRUE), male.n=sum(male.mid.authors.n, na.rm=TRUE))))
...
p10 <- ggplot(data=subset(arxiv.middle.long, as.Date(week) >= "2020-01-01" & as.Date(week) <= "2020-12-27"), aes(x=as.Date(week), y=n, color=gender, shape=gender))+geom_point(size=2)+geom_smooth(method="lm", se=FALSE)+ylab("Authorships (no.)")+xlab("Date")+theme_cowplot()+scale_color_manual(name="Gender", labels=c("Men", "Women"), values=colours2)+scale_shape_discrete(name="Gender", labels=c("Men", "Women"))+labs(title="arXiv", subtitle="middle authorships")+geom_vline(aes(xintercept=as.Date(who)), linetype="dashed")+scale_x_date(date_labels = "%b %Y")+theme(axis.text.x=element_text(angle=60, hjust=1), legend.position="top")
p10

#Model
arxiv.middle <- as.data.frame(ungroup(subset(df.all2020, as.Date(submitted) >= "2020-01-01" & as.Date(submitted) <= "2020-12-27") %>% group_by(as.Date(submitted)) %>% summarize(female.n=sum(female.mid.authors.n, na.rm=TRUE), male.n=sum(male.mid.authors.n, na.rm=TRUE))))
arxiv.middle.long <- gather(arxiv.middle, gender, n, female.n:male.n)
