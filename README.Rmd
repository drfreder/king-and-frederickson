...
What if we break it down further by author position, so first, middle, or last? 
...
The number of men first authors has grown only very slightly faster than the number of women first authors.
...
The number of men last authors has grown substantially year-over-year, but the number of women last authors is almost unchanged from 2019. 
...
The number of women middle authors actually declined from Mar/Apr 2019 to Mar/Apr 2020, while the number of men middle authors rose somewhat. 
...
How many male and female authors were there on bioRxiv preprints between Mar/Apr 2019 and 2020?
...
```{r Combine bioRxiv visualizations, message=FALSE, warning=FALSE, fig.width=16, fig.height=16, dpi=300}
